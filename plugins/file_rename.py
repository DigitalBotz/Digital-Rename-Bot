...
async def doc(bot, update):    
    ...
    ms = await update.message.edit("Rkn Developer Tʀyɪɴɢ Tᴏ Dᴏᴡɴʟᴏᴀᴅɪɴɢ....")    
    try:
    ...
    await ms.edit("Rkn Developer Tʀyɪɴɢ Tᴏ Uᴩʟᴏᴀᴅɪɴɢ....")
    ...
    try:
		...
		duration=duration,
	        progress=progress_for_pyrogram,
		progress_args=("Rkn Developer Uᴩʟᴏᴅ Sᴛᴀʀᴛᴇᴅ....", ms, time.time()))
        elif type == "audio": 
